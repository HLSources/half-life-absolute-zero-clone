...
//MODDD - NOTICE.
// File seems to be named "hud_spectator.h" instead of simply spectator.h
// (like ammo.h for CHudAmmo) as to not collide with dlls/spectator.h.
...
private:
	...
	SpriteHandle_t		m_hsprPlayerRed;
